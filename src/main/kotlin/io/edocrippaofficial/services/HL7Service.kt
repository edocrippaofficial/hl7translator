...
interface HL7Translator {
    fun convertToJson(hl7Message: String): Map<String, Any?>
}

class HL7Service(private val logger: Logger, private val mappings: Map<String, Any>) : HL7Translator {
    private val parser: Parser = PipeParser()

    override fun convertToJson(hl7Message: String): Map<String, Any?> {
